...
from app.bot.config import bot, DELAY_MINUTES_CONFIRM_SPOT
...
async def notify_user_about_found_spot(spot_confirmation_data: SpotConfirmationDTO):
    ...
    try:
        await confirmation_cache.set(spot_confirmation_data.tg_user_id, spot_confirmation_data)
