...
from app.utils.emoji_util import warn_emoji, clock_emoji, date_emoji, spot_emoji, sber_spot_emoji, sber_date_emoji
...
async def to_user_about_found_spot(spot_confirmation_data: SpotConfirmationDTO):
    ...
    message_text = (
        ...
        f"{sber_spot_emoji} <b>Место:</b> №{spot_confirmation_data.spot_number}\n"
        f"{sber_date_emoji} <b>Дата:</b> {spot_confirmation_data.assignment_date.strftime('%d.%m.%Y')}\n\n"
