...
from app.utils.emoji_util import warn_emoji, sber_emoji, sber_accept_emoji
...
async def take_spot(callback: CallbackQuery):
    ...
    with get_db_connection() as conn:
        ...
        await callback.message.edit_text(
            text=(
                f"{sber_accept_emoji} Вы успешно заняли место №{spot_confirmation_data.spot_number} "
